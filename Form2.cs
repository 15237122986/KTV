...
//////////////////////////播放、切歌、顶歌、重唱、删除//////////////////////////////////////
        ...
        private void SeeSong_Click(object sender, EventArgs e)
        {
            ...
            if (SeeSong.TextAlign.Equals(ContentAlignment.MiddleCenter))
            {
                listBox2.Visible = false;
                //TextAlign作为已点歌曲列表“打开”(MiddleCenter)和“未打开”(TopCenter)状态的一个条件
                SeeSong.TextAlign = ContentAlignment.TopCenter;
            }
            else
            {
